...
describe('Auth API Routes', () => {
    ...
    describe('login.js', () => {
        it('should login successfully and set cookies', async () => {
            ...
            expect(cookies.set).toHaveBeenCalledWith('sb-access-token', 'mock-access', expect.any(Object));
            expect(cookies.set).toHaveBeenCalledWith('sb-refresh-token', 'mock-refresh', expect.any(Object));
